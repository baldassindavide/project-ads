...
public class TelegramAPI {
    ...
    public String getUpdates() throws IOException { // get updates
        url = "https://api.telegram.org/bot5283513985:AAH1BGdQ2jeiQbxty_65JltrNSFFr-mvsXg/getUpdates";
    ...
    public void sendMessage(int chatID, String text) throws UnsupportedEncodingException, MalformedURLException, IOException {
        ...
        url = "https://api.telegram.org/bot5283513985:AAH1BGdQ2jeiQbxty_65JltrNSFFr-mvsXg/sendMessage?chat_id=" + Integer.toString(chatID) + "&text=" + textToSend; // create the API URL
        URL finalUrl = new URL(url);
        finalUrl.openStream();
    }
}
